...
//  Querys   //
    ...
    trabajo.trabajo_resumen, area_conocimiento.area_nombre, trabajo.trabajo_periodo, trabajo.trabajo_año, trabajo.trabajo_link, tutor.tutor_nombre, trabajo.trabajo_nota_grado
    FROM trabajo
    ...
    INNER JOIN tutor_x_trabajo ON trabajo.trabajo_id = tutor_x_trabajo.trabajo_id
    INNER JOIN tutor ON tutor_x_trabajo.tutor_id = tutor.tutor_id
            ...
            <div class="contenedor-trabajo-especifico">
                    ...
                    <div class="seccion-abajo">
                        ...
                        <div class="complementos">
                            <span>Tutor</span>
                            <p><?php echo $trabajo['tutor_nombre'] ?></p>
                            <br>
                            ...
                            <?php                             
                                if( $resultado->rowCount() >= 1){
                                    echo "<span>Líneas de investigación</span> ";
                                }
                            ?>
                            ...
                            <span>Nota de grado</span>
                            <p>
                                <?php echo $trabajo['trabajo_nota_grado'] ?>
                            </p>
